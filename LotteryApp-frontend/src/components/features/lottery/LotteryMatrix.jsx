...
export const CanadianFlag = () => <CircleFlag countryCode="ca" height="35" />
...
const countryConfigs = [
  ...
  { code: '+', name: 'additional', flag: '+', totalNumbers: 10 }
]
...
const LotteryMatrix = () => {
  ...
  return (
    <div className="min-h-screen bg-zinc-800">
      ...
      <div className="bg-white/10 backdrop-blur-sm rounded-lg w-full  py-2 my-1 border border-white/20">

    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-zinc-800 px-4">
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full border border-gray-100 flex flex-col items-center">
        <div className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-yellow-400 text-center mb-2">Payment Successful!</h2>
        ...
        <Link
          to="/dashboard"
          className="w-full py-3 rounded-xl bg-yellow-400 text-white font-bold text-center hover:bg-green-600 transition"
        >
          Back to Dashboard
        </Link>
      </div>

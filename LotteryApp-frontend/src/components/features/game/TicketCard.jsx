...
const TicketCard = ({ ticket, idx, onDelete, countryConfigs }) => {
  ...
  return (
    <motion.div
      ...
      className="relative  rounded-lg shadow-lg mb-4 overflow-hidden hover:shadow-xl transition-all duration-300 w-full max-w-md mx-auto"
    >
      {/* Close Button - Positioned at the very edge of top right corner */}
      <button
        onClick={onDelete}
        className="absolute right-0 top-0 z-20 w-6 h-6 bg-gray-200 hover:bg-red-500 text-gray-600 hover:text-white rounded-bl-lg flex items-center justify-center shadow transition-all duration-200 hover:scale-110"
      >
      ...
      <div className="p-4 bg-white relative">
        ...
        <div className="flex items-center justify-between pt-1 mb-1 border-b border-dashed border-gray-300 ml-2">
        ...
        {/* Selections Grid */}
        <div className="grid grid-cols-8  mb-4 mt-1">
